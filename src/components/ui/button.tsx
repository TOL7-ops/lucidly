...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 rounded-2xl shadow-glow",
        destructive: "bg-destructive text-destructive-foreground hover:bg-destructive/90 rounded-2xl",
        outline: "glass-card border-glass-border text-foreground hover:shadow-glow",
        ...
        dream: "btn-dream font-semibold text-primary-foreground shadow-cosmic hover:shadow-glow hover:scale-105",
        glass: "glass-card text-foreground font-semibold hover:shadow-glow backdrop-blur-xl",
        cosmic: "bg-gradient-aurora text-primary-foreground rounded-3xl font-bold shadow-cosmic hover:shadow-glow hover:scale-105 relative overflow-hidden",
      },
      size: {
